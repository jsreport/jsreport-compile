...
function compileExe (id, jsreportInfo, options) {
  ...
  return validateResources(
    options.bundle ? config.resources : config.resources.filter((res) => res.name === 'nexeres-ligth')[0].files
  ).then(function () {
    ...
    return compile('executable', config, Object.assign({}, options, opts))
  })
}

module.exports = function (options) {
  var nodeVersion = '4.7.3'
  var id = shortid()
