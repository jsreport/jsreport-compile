...
module.exports = function (options) {
  ...
  const getJsreport = prepareJsreport(execution)
...
function prepareJsreport (execution) {
  // we return a function to lazily create a jsreport instance when needed
  return function () {
    return execution.ensureTmpResources(['jsreportRuntime.js']).then(function () {
      return require(execution.resourceTempPath('jsreportRuntime.js'))
    })
  }
}
